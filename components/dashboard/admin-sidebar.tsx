    ...
    <aside className="flex w-64 flex-col border-r border-border bg-muted/30">
      ...
      <nav className="flex-1 space-y-1 px-3 py-4">
        ...
        <div className="pt-4">
          <Link
            href="/dashboard"
            className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-muted-foreground transition-colors hover:bg-foreground/5 hover:text-foreground"
          >
